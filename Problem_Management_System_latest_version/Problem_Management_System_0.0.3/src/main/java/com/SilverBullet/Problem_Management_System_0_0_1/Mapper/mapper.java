...
public interface mapper {
    ...
    void problemInsert(ProblemInfo p);
    ...
    List<String> trolleyProblemListSelect(String id, RowBounds rowBounds);

    String cnameGetByCid(String cid);

    void tempInsert(ProblemInfo p);
    String  tempIdSelect(String pid);
    List<ProblemInfo> getAllTemp();
    List<ProblemInfo> getTemp(String pid);
    void DeleteTemp(String pid);
